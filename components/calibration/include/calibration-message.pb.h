...
#define CalibrationUdpMessage_StateMessage_CalibrationRunMessage_init_default {0, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define ChargerStateUdpMessage_init_default      {0, 0, false, ChargerStateUdpMessage_StatusMessage_init_default, 0, false, ChargerStateUdpMessage_InitStatus_init_default, 0, 0, {{NULL}, NULL}, 0}
#define ChargerStateUdpMessage_InitStatus_init_default {0, {{NULL}, NULL}, 0, 0, 0, 0, 0, 0, 0}
#define ChargerStateUdpMessage_StatusMessage_init_default {0, 0, {{NULL}, NULL}}
...
#define CalibrationUdpMessage_StateMessage_CalibrationRunMessage_init_zero {0, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define ChargerStateUdpMessage_init_zero         {0, 0, false, ChargerStateUdpMessage_StatusMessage_init_zero, 0, false, ChargerStateUdpMessage_InitStatus_init_zero, 0, 0, {{NULL}, NULL}, 0}
#define ChargerStateUdpMessage_InitStatus_init_zero {0, {{NULL}, NULL}, 0, 0, 0, 0, 0, 0, 0}
#define ChargerStateUdpMessage_StatusMessage_init_zero {0, 0, {{NULL}, NULL}}
...
X(a, CALLBACK, REPEATED, STRING,   SelectedSerials,   2) \
X(a, CALLBACK, SINGULAR, STRING,   Key,               3) \
X(a, STATIC,   SINGULAR, UINT32,   ServerProtocol,    4)
#define CalibrationUdpMessage_StateMessage_CalibrationRunMessage_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   Serial,           10) \
X(a, STATIC,   SINGULAR, UINT32,   OverloadedPhases,  50)
#define ChargerStateUdpMessage_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   FirmwareVersion,   2) \
...
#define ChargerStateUdpMessage_InitStatus_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   Status,            3)
#define ChargerStateUdpMessage_StatusMessage_CALLBACK pb_default_field_callback
