...
#define CalibrationUdpMessage_StateMessage_CalibrationRunMessage_init_default {0, 0, NULL, NULL, 0}
...
#define CalibrationUdpMessage_StateMessage_CalibrationRunMessage_init_zero {0, 0, NULL, NULL, 0}
