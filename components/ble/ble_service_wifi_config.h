	...
	enum
	{
		...
		CHARGER_IT3_OPTIMIZATION_CHAR,
		CHARGER_IT3_OPTIMIZATION_UUID,
		CHARGER_IT3_OPTIMIZATION_DESCR,
		//CHARGER_PHASE_ROTATION_CFG,

		CHARGER_LOCATION_CHAR,
		CHARGER_LOCATION_UUID,
		
		CHARGER_TIMEZONE_CHAR,
		CHARGER_TIMEZONE_UUID,
		
		CHARGER_TIMESCHEDULE_CHAR,
		CHARGER_TIMESCHEDULE_UUID,
		
		CHARGER_RCDTEST_CHAR,
		CHARGER_RCDTEST_UUID,
		
		CHARGER_CAPABILITIES_CHAR,
		CHARGER_CAPABILITIES_UUID,

		CHARGER_SESSION_CONTROLLER_CHAR,
		CHARGER_SESSION_CONTROLLER_UUID,
		
		CHARGER_OCPP_NATIVE_URL_CHAR,
		CHARGER_OCPP_NATIVE_URL_UUID,
		
		CHARGER_OCPP_NATIVE_CONNECTED_CHAR,
		CHARGER_OCPP_NATIVE_CONNECTED_UUID,
