	...
	enum
	{
		...
		CHARGER_STAND_ALONE_CHAR,
		CHARGER_STAND_ALONE_UUID,
		CHARGER_STAND_ALONE_DESCR,
		//CHARGER_STAND_ALONE_CFG,

		CHARGER_STAND_ALONE_PHASE_CHAR,
		CHARGER_STAND_ALONE_PHASE_UUID,
		CHARGER_STAND_ALONE_PHASE_DESCR,
		//CHARGER_STAND_ALONE_PHASE_CFG,

		CHARGER_STAND_ALONE_CURRENT_CHAR,
		CHARGER_STAND_ALONE_CURRENT_UUID,
		CHARGER_STAND_ALONE_CURRENT_DESCR,
		//CHARGER_STAND_ALONE_CURRENT_CFG,
